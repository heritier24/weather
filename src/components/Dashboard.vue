        ...
        <div class="forecast-container">
          <div class="today forecast">
            ...
            <div class="forecast-content">
              ...
              <span><img src="images/icon-umberella.png" alt="" />Clouds: {{ weather.clouds.all}}</span>
              <span><img src="images/icon-wind.png" alt="" />Humidity: {{ weather.main.humidity }}</span>
              <span><img src="images/icon-compass.png" alt="" />timezone:{{ weather.timezone }}</span>
            </div>
          </div>
          <div class="forecast">
            <div class="forecast-header">
